...
ewrs.messageUpdateInterval = 40 --How often EWRS will update automated BRA messages (seconds)
...
ewrs.maxFriendlyDisplay = 4 -- Limits the amount of friendly aircraft shown on friendly picture
...
trigger.action.outText("EWRS is now active",15)
